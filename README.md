...
```shell
git clone https://github.com/sebviolet/blog2
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/blog2/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://sebviolet.github.io/blog2'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/sebviolet/blog2
  - link: https://github.com/sebviolet/blog2#readme
...
`https://sebviolet.github.io/blog2`